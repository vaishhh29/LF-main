...
const UploadRegistrationScreen: React.FC = () => {
 ...
 const handleContinue = async () => {
  ...
  try {
    ...
    // SAVE INTO: users/{uid}/cars/car1/registrationDetails
    await firestore()
      .collection("users")
      .doc(userId)
      .collection("cars")
    ...
    console.log("🔥 Registration details saved for:", userId);

    navigation.navigate("CarImageUpload");

  } catch (error) {
    console.log("Saving Error:", error);
    Alert.alert("Error", "Could not save registration details.");
  }
};
