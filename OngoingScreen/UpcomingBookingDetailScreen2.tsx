        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 16, paddingBottom: 100 }}>
                            ...
                            <View key={index} style={styles.trackRow}>
                                <View style={styles.trackLeft}>
                                    <View
                                        style={[
                                            styles.stepCircle,
                                            index <= 1 // ✅ first two steps are completed
                                                ? styles.stepDone
                                                : index === 2
                                                    ? styles.stepActive
                                                    : styles.stepIdle,
                ...
                <View style={styles.priceCardWrapper}>
                    <ImageBackground
                        source={require("./assets/bgboardpink.png")}
            ...
            <View style={styles.bottomBar}>
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("HandOverScreen")} // ✅ navigate here
                >
                    <Text style={styles.startText}>Complete trip</Text>
                </TouchableOpacity>
            </View>
